...
import { Play, Plus, ArrowRight, ArrowLeft, User, Hash, Users, Cpu } from "lucide-react";
...
export default function Lobby({ onJoin, onCreate, defaultName, onBackToMenu }: LobbyProps) {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              maxLength={15}
              className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 pt-2">
          ...
          <form onSubmit={handleJoin} className="space-y-3">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl font-mono text-center tracking-widest text-slate-700 placeholder-slate-400 uppercase font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm"
                />
              </div>
            </div>
            ...
            <button
              ...
              type="submit"
              className="w-full py-3.5 px-4 bg-slate-800 hover:bg-slate-900 active:scale-[0.98] text-white font-semibold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-slate-800/10 transition-all text-sm"
            >
